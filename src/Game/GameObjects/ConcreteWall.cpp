...
ConcreteWall::ConcreteWall(ConcreteWall::WallType wallType, const glm::vec2 &position, const glm::vec2 &scale,
                           float rotation) : IGameObject(position, scale, rotation),
